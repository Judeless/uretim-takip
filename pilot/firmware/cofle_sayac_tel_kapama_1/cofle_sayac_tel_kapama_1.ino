/* ============================================================
 *  COFLE PILOT SAYAC — TEL-KAPAMA-1 firmware (3 KANALLI)
 ...
 *
 *              GPIO25 -> Kapama 1      (istasyon 1)
 *              GPIO26 -> Kapama 2      (istasyon 2)
 *              GPIO27 -> Kapama 3      (istasyon 3)
 *
...
// ════════════════════════════════════════════════════════════
//   YAPILANDIRMA — TEL-KAPAMA-1
// ════════════════════════════════════════════════════════════

const char* CIHAZ_ID  = "TEL-KAPAMA-1";
...
const char* HB_ROBOT_NO = "Kapama 1-3";
...
const char* KANAL_ROBOT[KANAL_SAYISI] = { "Kapama 1", "Kapama 2", "Kapama 3" };
...
const char* FIRMWARE_VER  = "2.8.0-tel_kapama_1";   // 2.7.2 dayaniklilik paketi + 3 kanal
