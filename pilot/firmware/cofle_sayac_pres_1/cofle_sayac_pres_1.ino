/* ============================================================
 *  COFLE PILOT SAYAC — PRES-P1 firmware (v2.1)
 *  >>> OTOMATIK URETILDI: generate.py — manuel duzenleme!
 * ============================================================
 *
 *  HEDEF:  Pres 1 makinesinin KENDI SAYACINA takilan roleyi izler.
...
const char* CIHAZ_ID  = "PRES-P1";
const char* BOLUM     = "pres";
const char* ROBOT_NO  = "Pres 1";
...
const char* FIRMWARE_VER  = "2.8.0-pres_1";   // 2.8.0: SURE tabanli integrator (dongu hizindan bagimsiz) + cihaz bazli esik/gap + ISR kenar olcumu
