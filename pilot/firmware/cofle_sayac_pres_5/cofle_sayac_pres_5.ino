/* ============================================================
 *  COFLE PILOT SAYAC — PRES-P5 firmware (v2.1)
...
const char* CIHAZ_ID  = "PRES-P5";
const char* BOLUM     = "pres";
const char* ROBOT_NO  = "Pres 5";
...
const char* FIRMWARE_VER  = "2.8.0-pres_5";   // 2.8.0: SURE tabanli integrator (dongu hizindan bagimsiz) + cihaz bazli esik/gap + ISR kenar olcumu
