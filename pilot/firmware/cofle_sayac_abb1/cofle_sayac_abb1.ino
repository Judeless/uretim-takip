/* ============================================================
 *  COFLE PILOT SAYAC — ABB1-IO firmware (v2.1)
 *  >>> OTOMATIK URETILDI: generate.py — manuel duzenleme!
 * ============================================================
 *
 *  HEDEF:  ABB1 robotunun 3 dijital cikisini izler:
...
const char* FIRMWARE_VER  = "2.6.2-abb1";   // 2.6.2: WDT+OTA fix, non-blocking reconnect, retry backoff, WiFi-down hard reset, churn onleme
