/* ============================================================
 *  COFLE PILOT SAYAC — PLASTIK-407T firmware (v2.1)
 *  >>> OTOMATIK URETILDI: generate.py — manuel duzenleme!
 * ============================================================
 *
 *  HEDEF:  407T plastik enjeksiyon makinesinin uretim
...
const char* CIHAZ_ID  = "PLASTIK-407T";
const char* BOLUM     = "plastik";
const char* ROBOT_NO  = "407T";
...
const char* FIRMWARE_VER  = "2.6.2-407t";   // 2.6.2: WDT+OTA fix, non-blocking reconnect, retry backoff, WiFi-down hard reset, churn onleme
