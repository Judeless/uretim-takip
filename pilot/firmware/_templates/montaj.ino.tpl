...
const int           BUZZER_BEEP_ADET = __BUZZER_BEEP_ADET__;  // pes pese bip sayisi
const unsigned long BUZZER_BEEP_MS   = __BUZZER_BEEP_MS__;    // tek bip suresi (ms)
...
const bool BUZZER_AKTIF_HIGH = __BUZZER_AKTIF__;
...
const char* FIRMWARE_VER  = "2.7.3-__FW_SUFFIX__";   // 2.7.3: buzzer polarite cihaz-bazli + bip DESENI (adet/sure cihaz-bazli). 2.7.2: WDT+OTA fix, non-blocking reconnect, retry backoff, WiFi-down hard reset, churn onleme
