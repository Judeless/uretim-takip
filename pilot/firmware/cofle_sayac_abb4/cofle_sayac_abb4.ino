/* ============================================================
 *  COFLE PILOT SAYAC — ABB4-IO firmware (v2.1)
 *  >>> OTOMATIK URETILDI: generate.py — manuel duzenleme!
 * ============================================================
 *
 *  HEDEF:  ABB4 robotunun 3 dijital cikisini izler:
...
const char* CIHAZ_ID  = "ABB4-IO";
const char* BOLUM     = "kaynak";
const char* ROBOT_NO  = "ABB4";
...
const char* FIRMWARE_VER  = "2.6.2-abb4";   // 2.6.2: WDT+OTA fix, non-blocking reconnect, retry backoff, WiFi-down hard reset, churn onleme
