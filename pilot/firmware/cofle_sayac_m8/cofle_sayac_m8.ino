...
const char* FIRMWARE_VER  = "2.7.3-m8";   // 2.7.3: buzzer polarite cihaz-bazli + bip DESENI (adet/sure cihaz-bazli). 2.7.2: WDT+OTA fix, non-blocking reconnect, retry backoff, WiFi-down hard reset, churn onleme
