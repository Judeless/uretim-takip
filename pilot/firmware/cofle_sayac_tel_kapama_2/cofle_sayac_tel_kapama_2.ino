/* ============================================================
 *  COFLE PILOT SAYAC — TEL-KAPAMA-2 firmware (3 KANALLI)
 ...
 *
 *              GPIO25 -> Kapama 4      (istasyon 1)
 *              GPIO26 -> Kapama 5      (istasyon 2)
 *              GPIO27 -> Kapama 6      (istasyon 3)
 *
...
// ════════════════════════════════════════════════════════════
//   YAPILANDIRMA — TEL-KAPAMA-2
// ════════════════════════════════════════════════════════════

const char* CIHAZ_ID  = "TEL-KAPAMA-2";
...
const char* HB_ROBOT_NO = "Kapama 4-6";
...
const char* KANAL_ROBOT[KANAL_SAYISI] = { "Kapama 4", "Kapama 5", "Kapama 6" };
...
const char* FIRMWARE_VER  = "2.8.0-tel_kapama_2";   // 2.7.2 dayaniklilik paketi + 3 kanal
