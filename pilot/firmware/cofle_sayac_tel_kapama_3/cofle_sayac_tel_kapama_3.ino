/* ============================================================
 *  COFLE PILOT SAYAC — TEL-KAPAMA-3 firmware (3 KANALLI)
 ...
 *
 *              GPIO25 -> Kapama 7      (istasyon 1)
 *              GPIO26 -> Kapama 8      (istasyon 2)
 *              GPIO27 -> Kapama 9      (istasyon 3)
 *
...
// ════════════════════════════════════════════════════════════
//   YAPILANDIRMA — TEL-KAPAMA-3
// ════════════════════════════════════════════════════════════

const char* CIHAZ_ID  = "TEL-KAPAMA-3";
...
const char* HB_ROBOT_NO = "Kapama 7-9";
...
const char* KANAL_ROBOT[KANAL_SAYISI] = { "Kapama 7", "Kapama 8", "Kapama 9" };
...
const unsigned long INTEG_ESIK_US[KANAL_SAYISI] = {
  75UL * 1000UL, 75UL * 1000UL, 75UL * 1000UL };
...
const char* FIRMWARE_VER  = "2.8.0-tel_kapama_3";   // 2.7.2 dayaniklilik paketi + 3 kanal
