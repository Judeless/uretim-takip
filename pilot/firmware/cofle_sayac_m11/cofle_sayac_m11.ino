/* ============================================================
 *  COFLE PILOT SAYAC — MONTAJ-M11 firmware (v2.1)
...
const char* CIHAZ_ID  = "MONTAJ-M11";
const char* BOLUM     = "montaj";
const char* ROBOT_NO  = "M11";
...
const char* FIRMWARE_VER  = "2.7.3-m11";   // 2.7.3: buzzer polarite cihaz-bazli + bip DESENI (adet/sure cihaz-bazli). 2.7.2: WDT+OTA fix, non-blocking reconnect, retry backoff, WiFi-down hard reset, churn onleme
