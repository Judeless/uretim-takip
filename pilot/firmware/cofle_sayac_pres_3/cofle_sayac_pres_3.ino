/* ============================================================
 *  COFLE PILOT SAYAC — PRES-P3 firmware (v2.1)
 *  >>> OTOMATIK URETILDI: generate.py — manuel duzenleme!
 * ============================================================
 *
 *  HEDEF:  Pres 3 makinesinin KENDI SAYACINA takilan roleyi izler.
...
const char* CIHAZ_ID  = "PRES-P3";
const char* BOLUM     = "pres";
const char* ROBOT_NO  = "Pres 3";
...
const char* FIRMWARE_VER  = "2.8.0-pres_3";   // 2.8.0: SURE tabanli integrator (dongu hizindan bagimsiz) + cihaz bazli esik/gap + ISR kenar olcumu
