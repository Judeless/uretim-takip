/* ============================================================
 *  COFLE PILOT SAYAC — ABB3-IO firmware (v2.1)
 *  >>> OTOMATIK URETILDI: generate.py — manuel duzenleme!
 * ============================================================
 *
 *  HEDEF:  ABB3 robotunun 3 dijital cikisini izler:
...
const char* CIHAZ_ID  = "ABB3-IO";
const char* BOLUM     = "kaynak";
const char* ROBOT_NO  = "ABB3";
...
const char* FIRMWARE_VER  = "2.6.2-abb3";   // 2.6.2: WDT+OTA fix, non-blocking reconnect, retry backoff, WiFi-down hard reset, churn onleme
