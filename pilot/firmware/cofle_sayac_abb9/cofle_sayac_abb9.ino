/* ============================================================
 *  COFLE PILOT SAYAC — ABB9-IO firmware (v2.1)
 *  >>> OTOMATIK URETILDI: generate.py — manuel duzenleme!
 * ============================================================
 *
 *  HEDEF:  ABB9 robotunun 3 dijital cikisini izler:
...
const char* CIHAZ_ID  = "ABB9-IO";
const char* BOLUM     = "kaynak";
const char* ROBOT_NO  = "ABB9";
...
const char* FIRMWARE_VER  = "2.6.2-abb9";   // 2.6.2: WDT+OTA fix, non-blocking reconnect, retry backoff, WiFi-down hard reset, churn onleme
