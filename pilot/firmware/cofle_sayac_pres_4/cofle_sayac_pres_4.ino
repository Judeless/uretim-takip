/* ============================================================
 *  COFLE PILOT SAYAC — PRES-P4 firmware (v2.1)
 *  >>> OTOMATIK URETILDI: generate.py — manuel duzenleme!
 * ============================================================
 *
 *  HEDEF:  Pres 4 makinesinin KENDI SAYACINA takilan roleyi izler.
...
const char* CIHAZ_ID  = "PRES-P4";
const char* BOLUM     = "pres";
const char* ROBOT_NO  = "Pres 4";
...
const char* FIRMWARE_VER  = "2.8.0-pres_4";   // 2.8.0: SURE tabanli integrator (dongu hizindan bagimsiz) + cihaz bazli esik/gap + ISR kenar olcumu
